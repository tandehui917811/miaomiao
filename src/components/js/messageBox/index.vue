<template>
    <div class='messageBox'> 
        ...
        <p>{{ content }}</p>
        <div>
            <div @touchstart='handlerCancel'>{{ cancel }}</div>
            <div @touchstart='handlerok'>{{ ok }}</div>
        </div>
    </div>
</template>
...
<style scoped>
.messageBox{width: 200px;height: 120px;border: 1px solid #ccc;background: #fff;border-radius: 4px;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;top: 50%;margin:-60px 0 0 -100px;}
